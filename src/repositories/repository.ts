...
export default interface Repository{
    ...
    getAll(query?:any, sort?:any, pageSize?:number, pageNum?:number, attributes?:any) : Promise<{ query: any; pageSize: number; pageNum: number; resultSize: number; resultTotalSize: number; result: any[]; }>,
