...
class BaseRepository {
    constructor(model = null) {
        ...
        this.updatePartial = (id, partial) => __awaiter(this, void 0, void 0, function* () {
            return yield this.model.findByIdAndUpdate(id, { $set: partial });
        });
        ...
        this.isAuthor = (entityId, universalId) => __awaiter(this, void 0, void 0, function* () {
            return (yield this.model.count({ _id: entityId, author: universalId })) === 1;
        });
        this.model = model;
    }
}
