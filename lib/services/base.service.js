...
class BaseService {
    constructor(repository = null) {
        ...
        this.updatePartial = (request, entityId, partial) => __awaiter(this, void 0, void 0, function* () {
            if (!entityId) {
                throw this.buildError(400, "entityId is required.");
            }
            return yield this.repository.updatePartial(entityId, partial);
        });
        ...
        this.isAuthor = (entityId, universalId) => __awaiter(this, void 0, void 0, function* () {
            return yield this.repository.isAuthor(entityId, universalId);
        });
